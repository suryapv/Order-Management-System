...
<div id="page">
    ...
    <div class="left"> 
    <ul id="nav">
        <li><a id='im1'><img src="images/insert.jpg" id="1" align='left'>Menu 1</a>
            <ul class='count'>
        ...
        <li><a id='im2'><img src="images/insert.jpg" id="2" align='left'>Menu 2</a>
            <ul class='count'>
                <li><a>Sub-Menu 1</a></li>
                <li><a>Sub-Menu 2</a></li>
                <li><a>Sub-Menu 3</a></li>
        ...
        <li><a id='im3'><img src="images/insert.jpg" id="3" align='left'>Menu 3</a>
            <ul class='count'>
                <li><a>Sub-Menu 1</a></li>
                <li><a>Sub-Menu 2</a></li>
                <li><a>Sub-Menu 3</a></li>
